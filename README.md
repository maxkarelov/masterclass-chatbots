...
- [3 Создание функции обработчика](#3-Создание-функции-обработчика)
	...
	- [3.3 Добавить содержимое файлов bot/botHandler.js и bot/package.json. Скопировать адрес HTTP функции](#33-Добавить-содержимое-файлов-bot/botHandlerjs-и-bot/packagejson-Скопировать-адрес-HTTP-функции)
...
- [6 Создание сущности](#6-Создание-сущности)
	...
	- [6.4 Добавить CSV с возможными жанрами из datasets/genres.csv](#64-Добавить-CSV-с-возможными-жанрами-из-datasets/genrescsv)
...
- [8 Настройка веб хука](#8-Настройка-веб-хука)
	...
	- [8.2 Скопировать содержимое webhook/webhook.js и webhook/package.json в редактор и подеплоить cloud function](#82-Скопировать-содержимое-webhook/webhookjs-и-webhook/packagejson-в-редактор-и-подеплоить-cloud-function)
